...
- title: Register of Members Interests (latest register)
  ...
  schema:
    ...
    - name: free_text
      ...
      constraints:
        unique: false
      example: 'Name of donor: The Premier League Address of donor: Brunel Building,
        57 North Wharf Road, London W2 1HQ Amount of donation or nature and value
        if donation in kind: Two box tickets with hospitality for Arsenal v Everton,
        value £500 Date received: 22 May 2022 Date accepted: 22 May 2022 Donor status:
        company, registration 02719699 (Registered 14 June 2022)'
    ...
    - name: extracted_orgs
      ...
      constraints:
        unique: false
      example: The Premier League Address; Brunel Building; Arsenal v Everton
    - name: extracted_sum
      type: string
      ...
      constraints:
        unique: false
      example: ''
  hash: 5a47778baeb2c6177e6fef3544c334e9
full_version: 0.1.2
